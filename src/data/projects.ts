export const projects = [
   ...
   },
   {
      name: "Discord",
      description: {
         short: "A collection of tools, resources, and content for making the most out of Discord.",
         long: "This project is all about Discord—whether you need tools to manage a server, automate moderation, or just mess around with fun features. From useful utilities to deep dives into Discord-related topics, everything here is built to make your experience smoother, easier, or just more interesting.",
      },
      slug: "discord",
      banner: {
         src: "https://placehold.co/1000x500/000000/FFFFFF.webp",
